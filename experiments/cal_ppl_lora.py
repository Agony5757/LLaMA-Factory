...
def calculate_ppl(
    ...
    # load my arguments
    finetuning_args.use_quanta= use_quanta
    finetuning_args.use_qpeft= use_qpeft
    finetuning_args.qpeft_arch= qpeft_arch
    finetuning_args.qpeft_n_qlayers= qpeft_n_qlayers
    ...
    print(f"Average perplexity is {total_ppl / len(perplexities):.4f}")
